package com.example.lenovo.recyclerexample2.activity;
...
import com.example.lenovo.recyclerexample2.drawer.DrawerPresenterImpl;
...
public class MainActivity extends AppCompatActivity implements DrawerPresenterImpl.DrawerView, NavigationView.OnNavigationItemSelectedListener {
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings)
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/MrunaliB/RecyclerExample2")));
